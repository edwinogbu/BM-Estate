...
<head>
    ...
    <title>MB Estate Agency</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('dasboardMbCss/img/favicon.ico')}}">
    <!-- Google Fonts
		============================================ -->
    <link href="https://fonts.googleapis.com/css?family=Roboto:100,300,400,700,900" rel="stylesheet">
    <!-- Bootstrap CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/bootstrap.min.css')}}">
    <!-- Bootstrap CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/font-awesome.min.css')}}">
    <!-- owl.carousel CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/owl.theme.css')}}">
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/owl.transitions.css')}}">
    <!-- meanmenu CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/meanmenu/meanmenu.min.css')}}">
    <!-- animate CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/animate.css')}}">
    <!-- normalize CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/normalize.css')}}">
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/scrollbar/jquery.mCustomScrollbar.min.css')}}">
    <!-- jvectormap CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/jvectormap/jquery-jvectormap-2.0.3.css')}}">
    <!-- notika icon CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/notika-custom-icon.css')}}">
    <!-- wave CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/wave/waves.min.css')}}">
    <!-- main CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/main.css')}}">
    <!-- style CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/style.css')}}">
    <!-- responsive CSS
		============================================ -->
    <link rel="stylesheet" href="{{ asset('dasboardMbCss/css/responsive.css')}}">
    <!-- modernizr JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/vendor/modernizr-2.8.3.min.js')}}"></script>
</head>
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <!-- jquery
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/vendor/jquery-1.12.4.min.js')}}"></script>
    <!-- bootstrap JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/bootstrap.min.js')}}"></script>
    <!-- wow JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/wow.min.js')}}"></script>
    <!-- price-slider JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/jquery-price-slider.js')}}"></script>
    <!-- owl.carousel JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/owl.carousel.min.js')}}"></script>
    <!-- scrollUp JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/jquery.scrollUp.min.js')}}"></script>
    <!-- meanmenu JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/meanmenu/jquery.meanmenu.js')}}"></script>
    <!-- counterup JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/counterup/jquery.counterup.min.js')}}"></script>
    <script src="{{ asset('dasboardMbCss/js/counterup/waypoints.min.js')}}"></script>
    <script src="{{ asset('dasboardMbCss/js/counterup/counterup-active.js')}}"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/scrollbar/jquery.mCustomScrollbar.concat.min.js')}}"></script>
    <!-- jvectormap JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/jvectormap/jquery-jvectormap-2.0.2.min.js')}}"></script>
    <script src="{{ asset('dasboardMbCss/js/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
    <script src="{{ asset('dasboardMbCss/js/jvectormap/jvectormap-active.js')}}"></script>
    <!-- sparkline JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/sparkline/jquery.sparkline.min.js')}}"></script>
    <script src="{{ asset('dasboardMbCss/js/sparkline/sparkline-active.js')}}"></script>
    <!-- sparkline JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/flot/jquery.flot.js')}}"></script>
    <script src="{{ asset('dasboardMbCss/js/flot/jquery.flot.resize.js')}}"></script>
    <script src="{{ asset('dasboardMbCss/js/flot/curvedLines.js')}}"></script>
    <script src="{{ asset('dasboardMbCss/js/flot/flot-active.js')}}"></script>
    <!-- knob JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/knob/jquery.knob.js')}}"></script>
    <script src="{{ asset('dasboardMbCss/js/knob/jquery.appear.js')}}"></script>
    <script src="{{ asset('dasboardMbCss/js/knob/knob-active.js')}}"></script>
    <!--  wave JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/wave/waves.min.js')}}"></script>
    <script src="{{ asset('dasboardMbCss/js/wave/wave-active.js')}}"></script>
    <!--  todo JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/todo/jquery.todo.js')}}"></script>
    <!-- plugins JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/plugins.js')}}"></script>
	<!--  Chat JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/chat/moment.min.js')}}"></script>
    <script src="{{ asset('dasboardMbCss/js/chat/jquery.chat.js')}}"></script>
    <!-- main JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/main.js')}}"></script>
	<!-- tawk chat JS
		============================================ -->
    <script src="{{ asset('dasboardMbCss/js/tawk-chat.js')}}"></script>
</body>
