                                ...
                                <div class="panel-heading clearfix">
                                    <div class="panel-heading-title pull-left">
                                        ...
                                        <div class="buttonWrapper">
                                            <button type="button" class="btn btn-default btn-info pull-left btn-lg" data-toggle="modal" data-target="#myModal">ADD team</button>
                                        </div>
                                    </div>
                                    <!--panel-heading-title-->
                                ...
                                <div class="panel-body">
                                    <table class="table tableCyan table-striped-cyan ">
                                        <thead>
                                            <tr>
                                                <th>SN</th>
                                                <th>{{ __('Member Title Name') }}</th>
                                                <th>{{ __('Member Name') }}</th>
                                                <th>{{ __('Member Position') }}</th>
                                                <th>{{ __('Member Qualification') }}</th>
                                                <th>{{ __('Picture') }}</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $team->team_member_title }}</td>
                                                <td>{{ $team->team_member_name }}</td>
                                                <td>{{ $team->team_member_position }}</td>
                                                <td>{{ $team->team_member_qualification }}</td>
                                                <td>
                                                    <img src="{{ Storage::url($team->team_member_image) }}" alt="icon image" style="width: 100px; height: ;50px; border-radius:100%;">

                                                </td>
                                                <td>

                                                    <form action="{{ route('team.destroy', $team->id) }}" method="POST" enctype="">
                                                        @csrf

                                                        @method('DELETE')
                                                        <a href="{{ route('team.edit', $team->id) }}" type="button" class="btn btn-sm btn-info">Edit</a>
                ...
                <div class="col-lg-8 ">
                    <div class="panel panel-default h350">
                        <div class="panel-heading clearfix">
                            <div class="panel-heading-title pull-left">
                                <h6>Managed teams</h6>
                                <small>team REPORT OF THIS YEAR</small>
                            </div>
                            <!--panel-heading-title-->
                            <div class="panel-heading-buttons pull-right">
                                <div class="bs-example">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Create  team Us</h4>
            </div>
                ...
                <form id="add-agent-form" data-parsley-validate="" novalidate=""
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input value="" name="team_member_title" type="text" placeholder="team member title" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input value="" name="team_member_name" type="text" placeholder="team member NAME" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input value="" name="team_member_position" type="text" placeholder="team member Position" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                            <h6 class="modal-title">
                                            {{ __('MEMBER QUALIFICATIONS') }}
                                            </h6>
                                            </label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <textarea name="team_member_qualification" type="text" class="form-control" cols="4" ></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                            <h6 class="modal-title">
                                            {{__('Team Member Certification')}}
                                                </h6>
                                    </label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <textarea name="team_member_certification" type="text" class="form-control" cols="4" placeholder="enter team member certification" ></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                            <h6 class="modal-title">
                                            {{__('Team Member Award')}}
                                                </h6>
                                    </label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <textarea name="team_member_award" type="text" class="form-control" cols="4" placeholder="Enter team member award"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <textarea name="team_member_bio" type="text" class="form-control" cols="4" ></textarea>
                                    </div>
                                </div>
                                <div class="row inputWrapper ">
                                <br>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="left-inner-addon ">
                                                ...
                                                <input type="file" name="team_member_image" class="form-control" placeholder="team member image file">
                                                <label class="custom-file-label" for="customFile">Select icon image (800x896)</label>
