        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <div class="panel-heading-title  text-center">
                    <h6 style="color: #017700; text-align: center;"> EDIT B.M TEAM </h6>
                </div>
                <!--panel-heading-title-->
                        ...
                        <form id="add-agent-form" data-parsley-validate="" novalidate=""
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input value="{{ $team->team_member_title }}" name="team_member_title" type="text" placeholder="team member title" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input value="{{ $team->team_member_name }}" name="team_member_name" type="text" placeholder="team member NAME" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input value="{{ $team->team_member_position }}" name="team_member_position" type="text" placeholder="team member Position" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <textarea name="team_member_qualification" type="text" class="form-control" cols="4" >{{ $team->team_member_qualification }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                            <h6 class="modal-title">
                                            {{__('team_member_certification')}}
                                                </h6>
                                    </label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <textarea name="team_member_certification" type="text" class="form-control" cols="4" placeholder="enter team member certification" >{{ $team->team_member_certification }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <textarea name="team_member_award" type="text" class="form-control" cols="4" placeholder="Enter team member award">{{ $team->team_member_award }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <textarea name="team_member_bio" type="text" class="form-control" cols="4" >{{ $team->team_member_bio }}</textarea>
                                    </div>
                                </div>
                                <div class="row inputWrapper ">
                                <br>
