        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <div class="panel-heading-title  text-center">
                    <h6 style="color: #017700; text-align: center;"> INPUT FIELDS TO CREATE NEW PROPERTY </h6>
                </div>
                <!--panel-heading-title-->
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('property.store') }}"   method="POST" enctype="multipart/form-data" id="add-property-form">
                   @csrf
                   <div class="row inputWrapper ">
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-12 col-sm-8 col-lg-6">
                            <input value="" name="city" type="text" placeholder="city name" class="form-control">
                        </div>
                     </div>
                     <div class="form-group row">
                         <label class="col-12 col-sm-3 col-form-label text-sm-right">
                         ...
                         <div class="col-12 col-sm-8 col-lg-6">
                            <input value="" type="text" name="street_name" placeholder="street_name." class="form-control">
                        </div>
                     </div>
                     <div class="form-group row">
                         <label class="col-12 col-sm-3 col-form-label text-sm-right">
                         ...
                         <div class="col-12 col-sm-8 col-lg-6">
                            <input value="" name="house_number" type="number" placeholder="house number" class="form-control">
                        </div>
                     </div>
                     <div class="form-group row">
                         <label class="col-12 col-sm-3 col-form-label text-sm-right">
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-12 col-sm-8 col-lg-6">
                            <input value="" name="area" type="number" placeholder="Area" class="form-control">
                        </div>
                     </div>
                     <div class="form-group row">
                         <label class="col-12 col-sm-3 col-form-label text-sm-right">
                         ...
                         <div class="col-12 col-sm-8 col-lg-6">
                            <input value="" name="beds" type="number" placeholder="beds" class="form-control">
                        </div>
                     </div>
                     <div class="form-group row">
                         <label class="col-12 col-sm-3 col-form-label text-sm-right">
                         ...
                         <div class="col-12 col-sm-8 col-lg-6">
                            <input value="" name="baths" type="number" placeholder="baths" class="form-control">
                        </div>
                     </div>
                     <div class="form-group row">
                         <label class="col-12 col-sm-3 col-form-label text-sm-right">
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-12 col-sm-8 col-lg-6">
                            <input value="" name="rent" type="number" placeholder="rent" class="form-control">
                        </div>
                     </div>

                     <div class="form-group row">
                         <h6>
                            <label class="col-12 col-sm-3 col-form-label text-sm-right">{{ __('Property Status') }}</label>
                         </h6>
                        <div class="col-sm-6">
                            <div class="custom-controls-stacked">
                              {{-- @foreach($statuses as $status) --}}
                                <label class="custom-control custom-checkbox">
                                    ...
                                    name="status" type="radio" data-parsley-multiple="groups" value="1" data-parsley-mincheck="2" data-parsley-errors-container="#error-container1" class="custom-control-input">
                                    <span class="custom-control-label">Active</span>
                                </label>
                                <label class="custom-control custom-checkbox">
                                    <input

                                    name="status" type="radio" data-parsley-multiple="groups" value="0" data-parsley-mincheck="2" data-parsley-errors-container="#error-container1" class="custom-control-input">
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-12 col-sm-8 col-lg-6">
                            <input value="{{ old('type') }}" name="type" type="text" placeholder="Property Type" class="form-control">
                        </div>
                     </div>

                     <div class="form-group row">
                         <h6>
                             <label class="col-sm-3 col-form-label text-sm-right">{{ __('Agent List') }}</label>
                         </h6>
                        <div class="col-sm-6">
                            <div class="custom-controls-stacked">
                              @foreach($agents as $agent)
                                <label class="custom-control custom-checkbox">
                                    ...
                                    @if($agent->id == $property->agent_id)
                                      checked
                                    @endif
                                    type="radio" value="{{ $agent->id }}" name="agent_id"   class="checkbox-input">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                             <textarea name="about" class="form-control" cols="4"  placeholder="about property description">{{ old('about') }}</textarea>
                        </div>
                     </div>
                     <div class="row inputWrapper ">
                     ...
                     <div class="form-group row">
                            <label class="col-sm-3 col-form-label text-sm-right">
                                 <h6 class="modal-title">
                                 {{ __('Property Amenities') }}
                               </h6>
                            </label>
                            <div class="col-sm-6">
                                <div class="custom-controls-stacked checked">

                                @for ($i=0; $i <= 4; $i++)
                                <div class="row">
                                    <label class="pull-left text-sm-left">
                                        <h6 class="modal-title">
                                        {{ $i+1 }}
                                        </h6>
                                        </label>
                                    <div class="col-md-2">
                                        <input type="text" name="amenities[{{ $i }}][key]" class="form-control" value="{{ old('amenities['.$i.'][key]') }}" placeholder="key">
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" name="amenities[{{ $i }}][value]" class="form-control" value="{{ old('amenities['.$i.'][value]') }}" placeholder="amenities short description">
                                    </div>
                                </div>
                                @endfor
                                    <div id="error-container2"></div>
                           ...
                           <div class="form-group row">
                               <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                   <h6 class="modal-title">
                                       {{ __('Property vertical Image File') }}
                                   </h6>
                                   </label>
                               <div class="col-12 col-sm-8 col-lg-6">
                               <div class="left-inner-addon ">
                                   <i class="fa fa-file"></i>
                                   <input type="file" name="vertical_image" class="form-control" placeholder="Ensure a vertical image">
                           ...
                           <div class="form-group row">
                               <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                   <h6 class="modal-title">
                                       {{ __('Property horizontal Image File') }}
                                   </h6>
                                   </label>
                               <div class="col-12 col-sm-8 col-lg-6">
                               <div class="left-inner-addon ">
                                   <i class="fa fa-file"></i>
                                   <input type="file" name="horizontal_images" class="form-control" placeholder="Ensure a horizontal images custom file">
                                   <label class="custom-file-label" for="customFile">Select image (800x896)</label>
                           ...
                           <div class="modal-footer">
                               <div class="registrationButtonPlaseholder text-center">
                                   <div class="col col-sm-10 col-lg-9 offset-sm-1 text-center">
                                       <button
                                       type="submit"
                                       class="btn btn-default btn-info btn-lg pull-right btn-lg">
                                       {{ __('Save') }}
                                   </button>
