                                ...
                                <div class="panel-heading clearfix">
                                    <div class="panel-heading-title pull-left">
                                        ...
                                        <div class="buttonWrapper">
                                            <button type="button" class="btn btn-default btn-info pull-left btn-lg" data-toggle="modal" data-target="#myModal">ADD Property</button>
                                        </div>
                                    </div>
                                    <!--panel-heading-title-->
                                    ...
                                    <table class="table tableCyan table-striped-cyan ">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ __('About property') }}</th>
                                                <th>{{ __('price') }}</th>
                                                <th>{{ __('Agent name') }}</th>
                                                <th>{{ __('Agent Phone') }}</th>
                                                <th>{{ __('amenities') }}</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ Str::words(strtolower( $property->about), $words =5, $end='..' ) }}
                                                </td>
