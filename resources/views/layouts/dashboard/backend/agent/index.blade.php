                                ...
                                <div class="panel-heading clearfix">
                                    <div class="panel-heading-title pull-left">
                                        ...
                                        <div class="buttonWrapper">
                                            <button type="button" class="btn btn-default btn-info pull-left btn-lg" data-toggle="modal" data-target="#myModal">ADD AGENT</button>
                                        </div>
                                    </div>
                                    <!--panel-heading-title-->
        ...
        <form id="add-agent-form" data-parsley-validate="" novalidate=""
                ...
                <div class="row inputWrapper ">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                          <textarea name="about" class="form-control" cols="4" ></textarea>
                      </div>
                  </div>
                  {{-- @endforeach --}}
                  <div class="row inputWrapper ">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                          <div class="custom-controls-stacked checked-todo">
                            {{-- @foreach($properties as $property) --}}
                              <label class="custom-control custom-checkbox">
                                  ...
                                  " name="property
                                  {{-- {{$property->id}} --}}
                                  " data-parsley-multiple="group1" data-parsley-errors-container="#error-container2" class="custom-control-input">
                                  <span class="custom-control-label">
                                      {{-- {{ $property->city }}, {{ $property->street_name }}, {{ $property->house_number }} --}}
                                    </span>
                              </label>
                            {{-- @endforeach --}}
                  ...
                  <br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="left-inner-addon ">
                                ...
                                <input type="file" name="image" class="form-control" placeholder="custom file">
