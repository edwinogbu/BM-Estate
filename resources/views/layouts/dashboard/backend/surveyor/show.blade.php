        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <div class="panel-heading-title  text-center">
                    <h6 style="color: #017700; text-align: center;"> INPUT FIELDS TO CREATE NEW AGENT </h6>
                </div>
                <!--panel-heading-title-->
            ...
            <div class="panel-body">
                <div class="row inputWrapper">
                    ...
                    <table class="table table-striped table-bordered">
                        <tr>
                            <th width="50%" style="margin:50px;">primary_contact</th>
                            <td>{{ $mbService->primary_contact }}</td>
                        </tr>
                        <tr>
                            <th width="50%" style="margin:50px;">company</th>
                            <td>{{ $mbService->company }}</td>
                        </tr>
                        <tr>
                            <th width="50%" style="margin:50px;">first_name</th>
                            <td>{{ $mbService->first_name }}</td>
                        </tr>
                        <tr>
                            <th width="50%" style="margin:50px;">sur_name</th>
                            <td>{{ $mbService->sur_name }}</td>
                        </tr>
                        <tr>
                            <th width="50%" style="margin:50px;">prefer_contact</th>
                            <td>{{ $mbService->prefer_contact }}</td>
                        </tr>


                        <tr>
                            <th width="50%" style="margin:50px;">phone</th>
                            <td>{{ $mbService->phone }}</td>
                        </tr>


                        <tr>
                            <th width="50%" style="margin:50px;">email</th>
                            <td>{{ $mbService->email }}</td>
                        </tr>


                        <tr>
                            <th width="50%" style="margin:50px;">address</th>
                            <td>{{ $mbService->address }}</td>
                        </tr>


                        <tr>
                            <th width="50%" style="margin:50px;">city</th>
                            <td>{{ $mbService->city }}</td>
                        </tr>


                        <tr>
                            <th width="50%" style="margin:50px;">country</th>
                            <td>{{ $mbService->country }}</td>
                        </tr>

                        <tr>
                            <th width="50%" style="margin:50px;">code</th>
                            <td>{{ $mbService->code }}</td>
                        </tr>

                        <tr>
                            <th width="50%" style="margin:50px;">property_type</th>
                            <td>{{ $mbService->property_type }}</td>
                        </tr>

                        <tr>
                            <th width="50%" style="margin:50px;">known_size</th>
                            <td>{{ $mbService->known_size }}</td>
                        </tr>
                        <tr>
                            <th>property_size</th>
                            <td>{{ $mbService->property_size }}</td>
                        </tr>
                        <tr>
                            <th width="50%" style="margin:50px;">known_survey_copy</th>
                            <td>{{ $mbService->known_survey_copy }}</td>
                        </tr>
                        <tr>
                            <th width="50%" style="margin:50px;">survey_property_markers</th>
                            <td>{{ $mbService->survey_property_markers }}</td>
                        </tr>
                        <tr>
                            <th width="50%" style="margin:50px;">known_size</th>
                            <td>{{ $mbService->known_size }}</td>
                        ...
                        <tr>
                            <th width="50%" style="margin:50px;">service_required</th>
                            <td>
                        ...
                        <tr>
                            <th width="50%" style="margin:50px;">survey_purpose</th>
                            <td>
                                {{-- @foreach ($$mbService->survey_purpose as $item)
                                          {{ ($item) }}
                                @endforeach --}}
                            </td>
                        </tr>
                        <tr>
                            <th width="50%" style="margin:50px;">request_stage</th>
                            <td>{{ $mbService->request_stage }}</td>
                        </tr>
                        <tr>
                            <th width="50%" style="margin:50px;">date_of_Survey_plate</th>
                            <td>{{ $mbService->date_of_Survey_plate }}</td>
                        </tr>
                        <th width="50%" style="margin:50px;">
                            <td>{{ $mbService->message }}</td>
                        </tr>
