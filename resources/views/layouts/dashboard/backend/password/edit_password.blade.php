...
<div class="container">
    <div class="row justify-content-center">
              <!-- Main content -->
        <section class="content" style="background-color: gray;">
                <div class="row">
                                    ...
                                    <form action="{{ route('password.update', ) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            @csrf
                                                    <div class="form-group has-success row">
                                                        <div class="col-sm-3">
                                                            <label class="col-form-label" for="inputSuccess1">
                                                                <h5 style="color: #fff">Current Password <span class="text-danger">*</span></h5>
                                                    ...
                                                    <div class="form-group has-success row">
                                                        <div class="col-sm-3">
                                                            <label class="col-form-label" for="inputSuccess1">
                                                                <h5 style="color: #fff">New Password <span class="text-danger">*</span></h5>
                                                    ...
                                                    <div class="form-group has-success row">
                                                        <div class="col-sm-3">
                                                            <label class="col-form-label" for="inputSuccess1">
                                                                <h5 style="color: #fff">Confirm Password  <span class="text-danger">*</span></h5>
