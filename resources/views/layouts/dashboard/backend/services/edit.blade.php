        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <div class="panel-heading-title  text-center">
                    <h6 style="color: #017700; text-align: center;"> EDIT SERVICE INFO </h6>
                </div>
                <!--panel-heading-title-->
            ...
            <div class="panel-body">
                <div class="row inputWrapper">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input value="{{ $service->title }}" name="title" type="text" placeholder="service title" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <textarea name="text" type="text" class="form-control" cols="4" >{{ $service->text }}</textarea>
                        </div>
                    </div>
                    <div class="row inputWrapper ">
                    <br>
                ...
                <div class="modal-footer">
                    <div class="registrationButtonPlaseholder text-center">
                        ...
                        <a href="{{ route('services.index') }}" type="button" class="btn btn-default btn-info pull-left btn-lg" data-dismiss="modal">Back</a>
