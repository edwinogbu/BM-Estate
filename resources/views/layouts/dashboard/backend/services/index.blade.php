                                ...
                                <div class="panel-heading clearfix">
                                    <div class="panel-heading-title pull-left">
                                        ...
                                        <div class="buttonWrapper">
                                            <button type="button" class="btn btn-default btn-info pull-left btn-lg" data-toggle="modal" data-target="#myModal">ADD service</button>
                                        </div>
                                    </div>
                                    <!--panel-heading-title-->
                                    ...
                                    <table class="table tableCyan table-striped-cyan ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $service->text }}</td>
                                                <td>
                                                    <img src="{{ Storage::url($service->icon) }}" alt="icon image" style="width: 100px; height: ;50px; border-radius:100%;">
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('services.destroy', $service->id) }}" method="POST">
                                                        ...
                                                        @method('DELETE')
                                                        <a href="{{ route('services.edit', $service->id) }}" type="button" class="btn btn-sm btn-info">Edit</a>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Create  service Us</h4>
            </div>
                ...
                <form id="add-agent-form" data-parsley-validate="" novalidate=""
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input value="" name="title" type="text" placeholder="service title" class="form-control">
                            </div>
                        </div>
                        ...
                        <br>
                                ...
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                        <h6 class="modal-title">
                                            {{ __(' SERVICE ICON IMAGE') }}
                                        </h6>
                                        </label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                    <div class="left-inner-addon ">
                                        <i class="fa fa-file"></i>
                                        <input type="file" name="icon" class="form-control" placeholder="custom file">
