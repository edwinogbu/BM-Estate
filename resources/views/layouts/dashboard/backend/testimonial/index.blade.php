                                ...
                                <div class="panel-body">
                                    <table class="table tableCyan table-striped-cyan ">
                                        <thead>
                                            <tr>
                                                <th>SN</th>
                                                <th>{{ __('Testimonial Name') }}</th>
                                                <th>{{ __('Text') }}</th>
                                                <th>{{ __('testimonial_image ') }}</th>
                                                <th>{{ __('testimonial_mini_image') }}</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">1</th>
                                                <td>{{ $testimonial->names }}</td>
                                                <td>{{ $testimonial->text }}</td>
                                                <td>
                                                    <img src="{{ Storage::url($testimonial->testimonial_image) }}" alt="team image" style="width: 100px; height: ;50px; border-radius:100%;">

                                                </td>
                                                <td>
                                                    <img src="{{ Storage::url($testimonial->testimonial_mini_image) }}" alt="team image" style="width: 100px; height: ;50px; border-radius:100%;">
                                                ...
                                                <td class="pull-right">
                                                    <div class="butto-group">
                                                        ...
                                                        <a href="" class="btn btn-danger btn-sm" style="color: red;">
                ...
                <form id="add-agent-form" data-parsley-validate="" novalidate=""
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input value="" name="names" type="text" placeholder="testimonial name" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-12 col-sm-3 col-form-label text-sm-right">
                            ...
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input value="" name="text" type="text" placeholder="title name" class="form-control">
                            </div>
                        </div>
                        ...
                        <br>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="left-inner-addon ">
                                        ...
                                        <input type="file" name="testimonial_image" class="form-control" placeholder="custom horizontal_image file">
                                ...
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">
                                        <h6 class="modal-title">
                                            {{ __('Select testimonial_mini_image Image File') }}
                                        </h6>
                                        </label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                    <div class="left-inner-addon ">
                                        <i class="fa fa-file"></i>
                                        <input type="file" name="testimonial_mini_image" class="form-control" placeholder="custom vertical_image file">
