                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <div class="panel-heading-title  text-center">
                                        <h6 style="color: #017700; text-align: center;">  <div class="panel-heading-title pull-left">
                                            <h6>
                                                Team member
                                            </h6>
                                        </div>
                                    ...
                                    <div class="row">
                                        @foreach ($teams as $team)
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- About Me Box -->
                                                    {{-- <div class="box "> --}}
                                                        <div class="pic h-100 profile-user-img img-responsive img-circle" style="max-width: 600px; max-height: 500px;"><img src="{{ Storage::url($team->team_member_image) }}" alt="" class="h-100 img-responsive downloadFoto" style="width:800px; height: auto;"></div>

                                                            {{-- <div class="box-header with-border">
                                                                <h3 class="box-title" style="color: #fff">About Me</h3>
                                                            </div> --}}
                                                            <!-- /.box-header -->
                                                            {{-- <div class="box-body">
                                                        ...
                                                        <div class="box ">
                                                                ...
                                                                <div class="box-body">
                                                                    <h6>
                                                                        ...
                                                                        <strong><i class="fa fa-book margin-r-5"></i> Team Member Name</strong>
                                                                    </h6>
                                                                        <p class="text-muted">
                                                                            {{ $team->team_member_title }}
                                                                         {{ $team->team_member_name }}
