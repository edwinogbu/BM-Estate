...
<div id="mainWrapper" class="mainConteiner column">
    ...
    <div class="mainConteinerConten">
        <div class="container-fluid footerfix">
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default h550">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="lastFooter">
                                <ul>
                                    <li><span class="number1">1</span><span class="description">BM ESTATE company</span><span class="index">8%</span></li>
                ...
                <div id="lastWeek" class="col-lg-4 col-md-12" style="display: none;">
    ...
    <div class="fotterWrapper">
        EDDY@PAGINNOVATION © 2022 Copyright.
    </div>
    <!--fotterWrapper-->
</div>
@endsection
